...
// let put_locknote_validator = [
//   body("CPMRN").exists().isString(),
//   body("encounters").exists().isInt(),
//   body("noteId").exists(),
// ];

// deprecated this will note be used after uioverhaul gets to prod
// router.put(
//   "/locknote",
//   validateAccessToken,
//   accessScope("lock_note"),
//   patientUtil.checkIfDischargeTimeElapsed,
//   put_locknote_validator,
//   validator,
//   notesController.put_locknote
// );
...
router.put(
  "/notes/updatedraft/:CPMRN/:encounters",
  validateAccessToken,
